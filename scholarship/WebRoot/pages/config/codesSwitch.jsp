...
<html>
	...
	<body style="margin-top: 2px">
	  <s:form id="configForm" action="changeCodesSwitch" namespace="/config" method="post" theme="simple">
		<!--  左侧table-->
					...
					<table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-left: 18px;">
						...
						<tr>
							...
							<td align="left" width="60%">
								<c:if test="${codesSwitch eq 0}"><font color="red">关闭</font></c:if>
								<c:if test="${codesSwitch eq 1}"><font color="blue">开启</font></c:if>
							</td>
						</tr>
						<!-- 空行 -->
						<tr>
