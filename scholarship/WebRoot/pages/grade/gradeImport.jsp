...
.filestyle {
	...
	<body style="margin-top: 2px">
		<s:form action="import" namespace="/grade" method="post"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									...
									<span>如果班主任角色不存在自动创建(班主任_班级名)</span>
								</td>
							</tr>
							<tr>
								<td height="10px">
				...
				<tr>
					<td align="left" colspan="2">
						...
						<input type="button" class="btnyh" id="btnCancel" value="取   消"
							onclick="window.location.href='${ctx}/grade/query.action'" />
					</td>
				</tr>
			</table>
			...
			<!-- ui-dialog-account -->
			<c:if test="${repeatGradeList != null}">
