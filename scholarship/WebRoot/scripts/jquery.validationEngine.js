        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        // Is the form contained in an overflown container?
                        promptleftPosition += fieldWidth - 310;
                    else {
                        promptleftPosition += fieldWidth - 310;
                    ...
                    break;
                case "topLeft":
                    promptTopPosition += -promptHeight - 310;
                    break;
                case "centerRight":
                    promptleftPosition += fieldWidth + 313;
                    break;
                case "bottomLeft":
                    promptTopPosition = promptTopPosition + field.height() + 315;
                    break;
                case "bottomRight":
                    promptleftPosition += fieldWidth - 330;
                    promptTopPosition += field.height() + 305;
            }
