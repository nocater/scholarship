...
public class Datas {
	...
	public Datas(int id, Account account, String college, String major,
			...
			String address, String addressX, String distance, String expenses,
			String isLoan, String name_grandfather, String name_grandmother,
