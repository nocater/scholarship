...
public class ExportType7 extends Export {
	...
	/***
	 * 导出【附表7 黄冈师范学院"明珠学子"助学金学生名单备案表】
	 */
	public ExportType7(Account account, AccountService accountService,
	...
	public InputStream export(String year) {
		...
		String filePath = AppConfig.ctx+"csvTemplate\\附表7 黄冈师范学院'明珠学子'助学金学生名单备案表("+year+").xls";
	...
	private int werite(List<Account> accountList,WritableSheet sheet, String year, String category, int money) throws WriteException{
        ...
        label = new Label(0, 1, "黄冈师范学院\"明珠学子\"助学金学生名单备案表("+year+"年"+category+")");
